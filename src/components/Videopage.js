  ...
  return (
    <div className="w-full flex flex-col items-center justify-center h-screen relative">
      ...
      <div className="z-50 text-center text-white">
        <h1 className="h-full text-4xl md:text-[68px] leading-[90px] " style={{textShadow:'2px 2px 4px rgba(0, 0, 0, 0.7'}}>
        ...
        <p className="videopg-p md:text-xl" style={{textShadow:'2px 2px 4px rgba(0, 0, 0, 0.7'}}>
