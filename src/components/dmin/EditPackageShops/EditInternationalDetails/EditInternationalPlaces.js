...
function EditInternationalPlaces() {
  ...
  const fetchStates = () => {
    setLoading(true);
    axios
      .get("https://api.travelo10.com/api/admin/international/getBeautifulPlaces")
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://api.travelo10.com/api/admin/international/editBeautifulPlaces/${selectedActivity._id}`,
        formData,
        {
          headers: {
