...
function EditInternationalActivity() {
  ...
  const fetchStates = () => {
    setLoading(true);
    axios
      .get("https://api.travelo10.com/api/admin/international/getActivity")
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://api.travelo10.com/api/admin/international/editActivity/${selectedActivity._id}`,
        formData,
        {
          headers: {
...
export default EditInternationalActivity;
