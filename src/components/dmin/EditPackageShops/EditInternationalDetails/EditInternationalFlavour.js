...
function EditInternationalFlavour() {
  ...
  const fetchStates = () => {
    setLoading(true);
    axios
      .get("https://api.travello10.com/api/admin/international/getFlavour")
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://api.travello10.com/api/admin/international/editFlavour/${selectedActivity._id}`,
        formData,
        {
          headers: {
  ...
  const handleDelete = (activity) => {
    try {
      axios
        .delete(
          `https://api.travello10.com/api/admin/international/deleteFlavour/${activity._id}`
        )
        .then((response) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {states.map((activity) => (
              ...
              >
                ...
                <p>
                  <strong>Food Types:</strong> {activity.foodType}
                </p>
                <p>
...
export default EditInternationalFlavour;