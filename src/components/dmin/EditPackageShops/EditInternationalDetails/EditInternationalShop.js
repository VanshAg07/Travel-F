...
function EditInternationalShop() {
  ...
  const fetchStates = () => {
    setLoading(true);
    axios
      .get("https://api.travelo10.com/api/admin/international/getShop")
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://api.travelo10.com/api/admin/international/editShop/${selectedActivity._id}`,
        formData,
        {
          headers: {
...
export default EditInternationalShop;