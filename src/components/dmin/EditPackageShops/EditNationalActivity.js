...
function EditNationalActivity() {
  ...
  const fetchStates = () => {
    setLoading(true);
    axios
      .get("https://api.travelo10.com/api/admin/getActivity")
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .put(
        `https://api.travelo10.com/api/admin/editActivity/${selectedActivity._id}`,
        formData,
        {
          headers: {
...
export default EditNationalActivity;
