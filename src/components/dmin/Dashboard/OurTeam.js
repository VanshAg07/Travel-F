...
function OurTeam() {
  ...
  useEffect(() => {
    axios
      .get("https://api.travelo10.com/api/home/get-team-member")
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (teamId) {
        await axios.put(
          `https://api.travelo10.com/api/home/add-team-member/${teamId}`,
          formData,
          {
            headers: {
        ...
        await axios.post(
          "https://api.travelo10.com/api/home/add-team-member",
          formData,
          {
            headers: {
              "Content-Type": "multipart/form-data",
  ...
  const handleDelete = (id) => {
    axios
      .delete(`https://api.travelo10.com/api/home/add-team-member/${id}`)
      .then(() => {
        setReloadData(!reloadData);
      })
      .catch((error) => {
