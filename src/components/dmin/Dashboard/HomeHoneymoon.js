...
function HomeHoneymoon() {
  ...
  const fetchNationalData = async () => {
    try {
      const response = await axios.get(
        "https://api.travelo10.com/api/home/homepage-honeymoon"
      );
  ...
  const fetchChosenInternationalData = async () => {
    try {
      const response = await axios.get(
        "https://api.travelo10.com/api/home/homepage-choosen-honeymoon"
      );
  ...
  const handleDeletePackage = async (packageId) => {
    try {
      await axios.delete(
        `https://api.travelo10.com/api/home/homepage-honeymoon/${packageId}`
      );
