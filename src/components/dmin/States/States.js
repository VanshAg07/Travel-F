...
const States = () => {
  ...
  const fetchStates = async () => {
    try {
      const [
        ...
        axios.get("https://api.travelo10.com/api/admin/states"),
        axios.get("https://api.travelo10.com/api/trip/states"),
        axios.get("https://api.travelo10.com/api/honeymoon/states"),
        axios.get("https://api.travelo10.com/api/offer/states"),
        axios.get("https://api.travelo10.com/api/group-tours/state"),
      ]);
  ...
  const addInternationalState = async () => {
    ...
    try {
      const response = await axios.post(
        `https://api.travelo10.com/api/admin/international-state`,
        formData,
        {
          headers: {
  ...
  const addOfferState = async () => {
    ...
    try {
      const response = await axios.post(
        `https://api.travelo10.com/api/offer/states`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const addGroupTours = async () => {
    ...
    try {
      const response = await axios.post(
        `https://api.travelo10.com/api/group-tours/state`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const addNationalState = async () => {
    ...
    try {
      const response = await axios.post(
        `https://api.travelo10.com/api/trip/state`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const addHoneymoonState = async () => {
    ...
    try {
      const response = await axios.post(
        `https://api.travelo10.com/api/honeymoon/states`,
        formData,
        {
          headers: {
            "Content-Type": "multipart/form-data",
  ...
  const deleteOfferState = async (_id) => {
    try {
      await axios.delete(`https://api.travelo10.com/api/offer/states/${_id}`);
      fetchStates();
    } catch (error) {
  ...
  const deleteGroupTours = async (_id) => {
    try {
      await axios.delete(
        `https://api.travelo10.com/api/group-tours/state/${_id}`
      );
      fetchStates();
    } catch (error) {
      console.error(`Error deleting international state`, error);
  ...
  const deleteInternationalState = async (_id) => {
    try {
      await axios.delete(`https://api.travelo10.com/api/admin/state/${_id}`);
      fetchStates();
    } catch (error) {
      console.error(`Error deleting international state`, error);
    }
  ...
  const deleteNationalState = async (_id) => {
    try {
      await axios.delete(`https://api.travelo10.com/api/trip/state/${_id}`);
      fetchStates();
    } catch (error) {
      console.error(`Error deleting international state`, error);
    }
  ...
  const deleteHoneymoonState = async (_id) => {
    try {
      await axios.delete(`https://api.travelo10.com/api/honeymoon/state/${_id}`);
      fetchStates();
    } catch (error) {
      console.error(`Error deleting international state`, error);
    }
