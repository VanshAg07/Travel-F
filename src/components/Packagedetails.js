...
const Packagedetails = () => {
  ...
  <div className="bg-blue-300 p-3 border-b-2 border-blue-400 rounded-t-lg text-center">
  ...
  <form className="space-y-5">
   ...
   <div className="flex justify-between mt-4">
     <a
       ...
       className="flex items-center justify-center flex-1 bg-green-500 text-white font-semibold py-3 rounded-lg hover:bg-green-600 transition-all duration-300 text-sm md:text-base mr-2"
     >
     ...
     <button
       type="button"
       className="flex items-center justify-center flex-1 bg-blue-500 text-white font-semibold py-3 rounded-lg hover:bg-blue-600 transition-all duration-300 text-sm md:text-base ml-2"
       onClick={callNow}
     >
