      ...
      <div className="place-container">
        ...
        <div className="w-[80%] mx-auto pt-10 flex flex-col md:flex-row justify-between md:space-x-8">
          ...
          <div className="w-full md:w-[50%] flex flex-col items-start justify-start md:ml-0 mt-5 md:mt-0">
            <p className="text-yellow-400 text-3xl mt-10">
            ...
            <p className="text-left mt-3">
              ...
              packages ensure a seamless blend of work and leisure, leaving your
              team refreshed and inspired.
            </p>
            ...
            {expandedMore && (
              <>
                ...
                <p className="text-left">
                  * Build Team Camaraderie: Step outside the office environment
                  and foster stronger relationships through shared experiences.
                  <br></br>* Boost Creativity: A change of scenery sparks fresh
                  ideas and innovation.<br></br>* Relax and Recharge: Balance
                  work with relaxation, ensuring your team returns revitalized.
                  <br></br>* Incentive for Excellence: Reward top performers
                  with a travel experience that motivates the entire team.
                </p>
                <p className="font-bold mt-5 mb-2 text-left">
                ...
                <div className="mt-10">
                  ...
                  <p className="mt-3 text-left">
                    ...
                    combining business with leisure and fostering team bonding,
                    innovation, and growth. As a travel agency, offering
                    tailored MICE tour packages ensures your clients can host
                    successful events in exciting destinations while focusing on
                    business goals.
                  </p>
                  <p className="font-bold mt-5 mb-2 text-left">1. Meetings</p>
                  <p className="text-left">
                    MICE packages for meetings are designed to provide companies
                    with ideal locations for important gatherings, whether it’s
                    for team meetings, client consultations, or annual reviews.
                    Packages often include venue arrangements, transportation,
                    accommodation, and technology support like audio-visual
                    equipment.
                  </p>
                  <p className="font-bold mt-5 mb-2 text-left">2. Incentives</p>
                  <p className="text-left">
                  ...
                  <p className="text-left">
                    ...
                    business partners together to share insights and strategies.
                    MICE tour packages for conferences typically include large
                    venue bookings, accommodation, logistics management,
                    catering, and entertainment, often in major business hubs or
                    scenic destinations.
                  </p>
                  <p className="font-bold mt-5 mb-2 text-left">
                    4. Exhibitions
                  ...
                  <p className="text-left">
                    ...
                    showcasing products and services. These tours often include
                    event space rentals, exhibition booth setups, travel
                    arrangements for the team, and networking opportunities to
                    engage with potential clients or partners.
                  </p>
                </div>
                <div className="mt-10">
                  ...
                  <p>
                    Incentive travel rewards top-performing employees, offering
                    a break from routine while recognizing their contributions.
                    It boosts morale, strengthens company loyalty, and motivates
                  ...
                  <p>
                    ...
                    activities foster stronger relationships, improving teamwork
                  ...
                  <p>
                    ...
                    partners, and clients in a more personal and impactful way.
                    Face-to-face interactions during such events strengthen
                  ...
                  <p>
                    ...
                    attending these events, companies can stay ahead of industry
                    developments, gain valuable knowledge, and explore growth
                    opportunities.
                  </p>
                  <p className="font-bold mt-5 mb-2 ">
                  ...
                  <p>
                    MICE trips offer the perfect blend of business and leisure,
                    allowing participants to work and relax in exciting
                    destinations. From luxury resorts to cultural tours,
                    employees and partners can recharge while staying engaged in
                ...
                <div className="mt-10">
                  ...
                  <p>
                    ...
                    are essential for companies looking to blend corporate
                    objectives with memorable experiences. From team-building
                    retreats to international conferences, we offer
                    comprehensive packages that make planning and executing your
                    business events stress-free and successful
                  </p>
                  <p className="font-bold mt-5 mb-2 ">
                  ...
                  <p>
                    Reward your team with unforgettable incentive trips designed
                    to celebrate success and inspire future achievements. We
                    offer a range of exciting destinations and experiences, from
                    luxury retreats to adventure-filled getaways, combining
                    relaxation with team-building activities. Let your top
                    performers recharge while building stronger bonds with their
                    colleagues.
                  </p>
                  <p className="font-bold mt-5 mb-2 ">
                  ...
                  <p>
                    Our comprehensive conference services are designed to handle
                    every aspect of large-scale business events. From delegate
                    management and travel arrangements to on-site logistics and
                    post-event entertainment, we ensure your conference runs
                    smoothly. We provide venue booking, accommodation, speaker
                    management, and technical support, so you can focus on
                    delivering valuable insights and networking.
                  </p>
                  <p className="font-bold mt-5 mb-2 ">
                ...
                <div className="mt-10">
                  ...
                  <p>
                    * Global Destinations: From serene resorts to bustling
                    business hubs, we offer a variety of destinations that cater
                    to both business and leisure.
                  </p>
                  <p>
                ...
                <div className="mt-10">
                  ...
                  <p>
                    With our MICE travel services, your corporate events will be
                    more than just business. They’ll be an opportunity to
