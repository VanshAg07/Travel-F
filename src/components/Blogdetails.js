  ...
  const blogContent = {
    kedarnath: {
      ...
      content: (
        <>
          ...
          <div className="w-[80%] mx-auto pt-14 flex flex-col md:flex-row justify-between md:space-x-8">
            <div className="w-full md:w-[50%] flex flex-col items-start justify-start md:ml-0 mt-5 md:mt-0">
              <p className="text-yellow-500 font-bold text-3xl mt-10">
              ...
              <div className="mt-10">
                ...
                <p className="mt-3 text-left">
                  Kedarnath’s spiritual aura is steeped in mythology and
                  history. According to legends, the temple was built by the
                  Pandavas to seek Lord Shiva’s forgiveness after the
                  Kurukshetra war. The present-day temple, believed to have been
                  constructed by Adi Shankaracharya in the 8th century, stands
                  as a symbol of devotion and resilience, having withstood the
                  test of time and nature.
                </p>
                <p className="mt-3 text-left">
                  The temple’s architecture is a marvel, with its stone walls
                  and conical Shiva lingam, which is believed to be the hump of
                  Lord Shiva in his bull form. The aarti at Kedarnath is a
                  soul-stirring experience, with the chants reverberating
                  through the valley, creating an atmosphere of divine serenity.
                </p>
              </div>
              <div className="mt-10">
                <p className="font-bold text-2xl text-yellow-500 text-left">
                  Where to Stay: Accommodation in Kedarnath
                </p>
                <p className="mt-3 text-left">
                  Accommodation options in Kedarnath range from basic lodges to
                  more comfortable hotels, catering to different budgets. Most
                  pilgrims choose to stay in Gaurikund, Sonprayag, or Phata,
                  where there are several guesthouses and dharamshalas. Early
                  booking is recommended, especially during the peak pilgrimage
                  season.
                </p>
                <p className="mt-3 text-left">
                  For those looking for a more immersive experience, staying at
                  one of the guesthouses in Kedarnath itself allows you to soak
                  in the tranquil atmosphere of the place after the day’s
                  visitors have left.
                </p>
              </div>
            </div>
          ...
          <div className="w-[80%] mx-auto pt-10 flex flex-col md:flex-row justify-between md:space-x-8">
            ...
            <div className="w-full md:w-[50%] flex flex-col items-start justify-start md:ml-0 mt-5 md:mt-0">
              ...
              <p className="font-bold mt-5 mb-2 text-left">Vasuki Tal:</p>
              <p className="text-left">
                An 8 km trek from Kedarnath, Vasuki Tal is a stunning glacial
                lake surrounded by towering peaks. The trek is a challenging
                one, but the sight of the crystal-clear waters reflecting the
                sky is worth the effort.
              </p>
              <p className="font-bold mt-5 mb-2 text-left">Gandhi Sarovar:</p>
              <p className="text-left">
                Just 4 km from Kedarnath, this small lake, also known as
                Chorabari Tal, is a popular spot for its serene beauty and the
                panoramic views it offers.{" "}
              </p>
              <p className="font-bold mt-5 mb-2 text-left">
                Triyuginarayan Temple:
              </p>
              <p className="text-left">
                Located 25 km from Kedarnath, this temple is where Lord Shiva
                and Goddess Parvati are believed to have been married. The
                eternal flame in front of the temple is said to have been
                burning since their wedding.{" "}
              </p>
              <div className="mt-10">
                <p className="text-yellow-400 text-2xl font-bold">
                  Travel Tips for Kedarnath
                </p>
                <p className="font-bold mt-5 mb-2 text-left">Pack Wisely:</p>
                <p className="text-left">
                  Carry warm clothes, trekking shoes, a raincoat, and essential
                  medications. The weather in Kedarnath can be unpredictable, so
                ...
                <p className="text-left">
                  Acclimatize yourself before starting the trek to avoid
                  altitude sickness. Carry a first aid kit and stay hydrated.
                </p>
                <p className="font-bold mt-5 mb-2 text-left">
                  Respect Nature and the Local Culture:
                </p>
                <p className="text-left">
                  Avoid using plastic and dispose of waste responsibly. Respect
                  the local customs and traditions, especially in sacred spaces.
                </p>
              </div>
              <div className="mt-10 mb-10">
                <p className="font-bold text-2xl text-yellow-500 text-left">
                  Conclusion: Experience the Divine with Travello10
                </p>
                <p className="mt-3 text-left">
                  Kedarnath is more than just a pilgrimage; it’s a journey of
                  self-discovery, offering a rare blend of spirituality and
                  natural beauty. At Travello10, we ensure that your Kedarnath
                  experience is seamless, from travel arrangements to
                  accommodation. Let us take you on a journey that you will
                  cherish forever.{" "}
                </p>
              </div>
            </div>
      ...
      content: (
        <>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
            Discover Kedarnath: A Spiritual Sojourn in the Himalayas
          </h1>
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            5. Spiritual and Historical Sites:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Conclusion: Experience the Magic of Kashmir with Travello10
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
    ...
    ladakh: {
      ...
      content: (
        <>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
            Experience the Untamed Beauty of Ladakh with Travello10
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Why Ladakh Should Be on Your Bucket List
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            3. Nubra Valley – The Desert in the Mountains:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            5. Tso Moriri – A Tranquil Lake in the Changthang Plateau:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Conclusion: Explore Ladakh with Travello10
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
    ...
    himachalpradesh: {
      ...
      content: (
        <>
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Why Himachal Pradesh Should Be Your Next Travel Destination
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            3. Dharamshala – The Spiritual Retreat:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            4. Spiti Valley – The Land of Monasteries:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            2. River Rafting in Kullu-Manali:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            4. Exploring Temples and Monasteries:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            5. Experiencing Local Culture and Festivals:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Conclusion: Experience Himachal Pradesh with Travello10
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
    ...
    udaipur: {
      ...
      content: (
        <>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
            Discover the Royal Charm of Udaipur with Travello10
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Why Udaipur Should Be Your Next Travel Destination
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            2. Lake Pichola – The Heart of Udaipur:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            3. The Romantic Taj Lake Palace:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            4. Saheliyon Ki Bari – The Garden of the Maidens:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            4. Cultural Performances at Bagore Ki Haveli:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            5. Exploring the Vintage Car Museum:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            Plan Your Visits to the Palaces and Temples Early:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Conclusion: Explore Udaipur with Travello10
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
    ...
    kerala: {
      ...
      content: (
        <>
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            2. Munnar – The Emerald Green Hills:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            3. Kovalam – The Perfect Beach Getaway:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            4. Thekkady – Wildlife and Adventure in the Heart of Kerala:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            5. Fort Kochi – A Cultural and Historical Melting Pot:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Conclusion: Discover Kerala with Travello10
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
    ...
    meghalaya: {
      ...
      content: (
        <>
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">
            Unveil the Mystical Beauty of Meghalaya with Travello10
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya, the "Abode of Clouds," is a land where nature's beauty
            and tranquility reign supreme. Nestled in the northeastern part of
            India, this stunning state is renowned for its misty hills, pristine
            waterfalls, and vibrant tribal culture. Meghalaya is an ideal
            destination for those seeking an offbeat travel experience, with its
            breathtaking landscapes, rich biodiversity, and warm hospitality.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Why Meghalaya Should Be Your Next Travel Destination
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya’s unspoiled beauty and serene environment make it a haven
            for nature lovers and adventure enthusiasts. Here’s why Meghalaya
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Cherrapunji, one of the wettest places on Earth, is famous for its
            unique living root bridges. These natural wonders are crafted by the
            Khasi tribe using the roots of rubber trees, creating bridges that
            can withstand the test of time. Trekking through the lush forests to
            reach these bridges is an unforgettable experience, offering a
            glimpse into the harmony between nature and human ingenuity.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            2. Shillong – The Scotland of the East:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Shillong, the capital of Meghalaya, is a charming hill station with
            a blend of colonial-era architecture, vibrant markets, and serene
            landscapes. Known for its cool climate and picturesque surroundings,
            Shillong is often referred to as the "Scotland of the East." Visit
            the Shillong Peak for panoramic views of the city, explore the lush
            gardens of Ward’s Lake, and immerse yourself in the local culture at
            the bustling Police Bazaar.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            3. Mawlynnong – Asia’s Cleanest Village:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Mawlynnong, often hailed as the cleanest village in Asia, is a model
            of eco-friendly living and sustainable tourism. The village is
            adorned with well-maintained gardens, bamboo houses, and spotless
            pathways, reflecting the community’s commitment to cleanliness and
            environmental conservation. A visit to Mawlynnong is not only a
            refreshing escape but also an inspiration for sustainable living.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            4. Dawki – Crystal Clear Waters of Umngot River:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Dawki, a small town on the India-Bangladesh border, is home to the
            mesmerizing Umngot River, known for its crystal-clear waters. A boat
            ride on this river gives the illusion of floating on air, as the
            water is so transparent that you can see the riverbed clearly. The
            stunning landscape, combined with the serene atmosphere, makes Dawki
            a must-visit destination for nature lovers and photographers.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            5. Nohkalikai Falls – The Tallest Plunge Waterfall in India:
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Nohkalikai Falls, located near Cherrapunji, is the tallest plunge
            waterfall in India, cascading from a height of over 1,100 feet. The
            sight of the water plunging into a deep green pool below is
            awe-inspiring, and the surrounding mist-covered cliffs add to the
            dramatic beauty of the place. The falls are named after a local
            legend, adding a touch of mystique to this natural wonder.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Best Time to Visit Meghalaya
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya’s climate is pleasant throughout the year, but the best
            time to visit depends on the experiences you seek.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Winter (October to February):
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            The winter months are ideal for exploring Meghalaya’s natural
            beauty, with cool and comfortable weather. This is the best time for
            trekking, sightseeing, and enjoying the waterfalls, which are still
            in full flow after the monsoon.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Monsoon (June to September):
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            The monsoon season brings heavy rainfall, transforming Meghalaya
            into a lush green paradise. The waterfalls are at their most
            spectacular during this time, and the landscape is covered in a
            carpet of vibrant greenery. While some areas may be challenging to
            access due to the rain, the monsoon is a great time to experience
            Meghalaya’s raw and untamed beauty.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Summer (March to May):
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Summers in Meghalaya are mild and pleasant, making it a great time
            for outdoor activities and exploring the hill stations. The
            temperatures are comfortable, and the landscape remains lush and
            inviting.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
          ...
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            1. Trekking to Double Decker Living Root Bridge:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            One of the most iconic experiences in Meghalaya is trekking to the
            Double Decker Living Root Bridge in Nongriat village. The trek takes
            you through dense forests, crossing several smaller root bridges and
            streams along the way. The double-decker bridge is a marvel of
            nature and engineering, and the journey to reach it is as rewarding
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya is home to some of the longest and most complex cave
            systems in India. Caving in Meghalaya offers a thrilling adventure
            as you explore the underground world of stalactites, stalagmites,
            and underground rivers. Popular caves like Mawsmai Cave, Liat Prah
            Cave, and Siju Cave provide a glimpse into the hidden wonders of
            Meghalaya.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            3. Experiencing Khasi and Garo Culture:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya is rich in tribal culture, with the Khasi, Garo, and
            Jaintia tribes forming the majority of the population. Visiting
            traditional villages, attending local festivals, and interacting
            with the indigenous people offer insights into their customs,
            traditions, and way of life. The Wangala Festival of the Garo tribe
            and the Nongkrem Dance of the Khasi tribe are cultural highlights
            not to be missed.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            4. Exploring the Living Root Bridges of Riwai:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Apart from the famous double-decker bridge, Riwai village near
            Mawlynnong is home to several other living root bridges that are
            less visited but equally stunning. These bridges, surrounded by
            dense forests and picturesque landscapes, offer a peaceful and
            serene experience away from the more popular tourist spots.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            5. Visiting the Sacred Forests:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            The sacred groves of Meghalaya are protected by local communities
            for centuries, believed to be the abode of spirits. The Mawphlang
            Sacred Forest is one such grove, where the lush vegetation and
            ancient trees create an almost otherworldly atmosphere. A guided
            walk through the forest provides insights into the local beliefs and
            the importance of conservation in Meghalaya.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            Accommodation in Meghalaya
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya offers a range of accommodation options, from luxury
            resorts and boutique hotels to cozy homestays and eco-friendly
            lodges. Whether you prefer the comfort of a hilltop resort with
            panoramic views or the warmth of a traditional Khasi homestay,
            Meghalaya has something to suit every traveler’s preference and
            budget.
          </p>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            For a more immersive experience, consider staying in one of the
            eco-lodges or community-run guesthouses, where you can enjoy the
            natural surroundings while supporting sustainable tourism
            initiatives.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya’s weather can be unpredictable, especially during the
            monsoon season. Pack light layers, waterproof clothing, and sturdy
            footwear to stay comfortable during your trip.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            Respect Local Traditions:
          </h3>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            The people of Meghalaya are deeply connected to their culture and
            traditions. Dress modestly, especially in rural areas, and always
            seek permission before taking photographs of people or religious
            sites.
          </p>
          <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium mt-4">
            Sustainable Travel:
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya’s pristine environment is one of its greatest assets. Be a
            responsible traveler by minimizing plastic waste, using eco-friendly
            products, and respecting the natural surroundings. Support local
            communities by choosing locally-owned accommodations and purchasing
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            While major towns like Shillong have good connectivity, remote areas
            may have limited access to mobile networks and internet. Inform your
            loved ones of your travel plans in advance, and be prepared to
            disconnect and enjoy the tranquility of nature.
          </p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold mt-6">
            Conclusion: Discover Meghalaya with Travello10
          </h2>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Meghalaya is a destination that offers a perfect blend of adventure,
            culture, and natural beauty. At Travello10, we are dedicated to
            curating unforgettable experiences that showcase the best of this
            enchanting state. From personalized itineraries to expert guides and
            handpicked accommodations, we ensure that your journey through
            Meghalaya is seamless and memorable.
          </p>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
            Let us take you on a royal journey through the "City of Lakes."
            Embark on an adventure to the "Abode of Clouds" with us. Contact
            Travello10 today to start planning your dream trip to Meghalaya!{" "}
          </p>
        </>
      ),
    },
