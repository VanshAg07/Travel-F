...
const Navbar = () => {
  ...
  const fetchNationalNav = async () => {
    try {
      const res = await axios.get(
        "https://api.travelo10.com/api/home/get-national-nav"
      );
  ...
  const fetchInternNationalNav = async () => {
    try {
      const res = await axios.get(
        "https://api.travelo10.com/api/home/get-international-nav"
      );
  ...
  const fetchHoneymoonNav = async () => {
    try {
      const res = await axios.get(
        "https://api.travelo10.com/api/home/get-honeymoon-nav"
      );
